  ...
  notes: [
    ...
    'notes/web-components/web-components',
    {
      ...
      items: [
        ...
        'notes/javascript/object-oriented-programming',
      ],
    },
      ...
      items: [
        'courses/rocketseat/ignite/node-js/course/2023/introduction',
        {
          'Chapter 01': [
            ...
            'courses/rocketseat/ignite/node-js/course/2023/chapter-01/section-05',
          ],
        },
      ],
    },
      ...
      items: [
        'courses/the-complete-javascript-course/the-complete-javascript-course',
        {
          Course: [
            ...
            'courses/the-complete-javascript-course/course/section-14',
          ],
        },
      ],
    },
      ...
      items: [
        'courses/advanced-css-and-sass/advanced-css-and-sass',
        {
          Course: [
            ...
            'courses/advanced-css-and-sass/course/section-08',
            'courses/advanced-css-and-sass/course/section-09',
            'courses/advanced-css-and-sass/course/section-10',
          ],
        },
      ],
    },
