---
id: section-05
title: Ignite React.js · Chapter 02 · Section 05
...
```typescript {4,30,59-63} title="src/hooks/useTransactions.tsx"
import {
  createContext,
  ReactNode,
  useContext,
...
```typescript {7} title="src/App.tsx"
import { useState } from 'react';
import Modal from 'react-modal';
import { Dashboard } from './components/Dashboard';
import { Header } from './components/Header';
...
```typescript {4,8} title="src/components/NewTransactionalModal/index.tsx"
...
```typescript {4,8} title="src/components/Summary/index.tsx"
import IncomeImg from '../../assets/income.svg';
import OutcomeImg from '../../assets/outcome.svg';
import TotalImg from '../../assets/total.svg';
import { useTransactions } from '../../hooks/useTransactions';
...
```typescript {1,5} title="src/components/TransactionTable/index.tsx"
import { useTransactions } from '../../hooks/useTransactions';
import { Container } from './styles';
